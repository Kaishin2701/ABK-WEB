(function () {
  ...
  const clubNames = [
    ...
    "ATK Mohun Bagan",
    "Atlanta United FC",
    "AtlÃ¨tic Club d\u0027Escaldes",
    "AtlÃ©tico Baleares",
    "AtlÃ©tico EspeleÃ±o",
    "Atletico Madrid",
    "AtlÃ©tico PulpileÃ±o",
    "AUGC Deportiva",
    "Austin",
    "Auxerre",
    "Aveley",
    ...
    "Gillingham",
    "Gimnastic",
    "GimnÃ¡stica Segoviana",
    "GimnÃ¡stica Torrelavega",
    "Girona",
    "Gjilani",
  ...
  const additionalClubNames = [
    ...
    "Villarreal", "West Ham United", "Wolverhampton Wanderers"
  ];

  const aliases = {
    "Liverpool": ["Lvrp00l"],
    "Arsenal": ["Arsen^_^al", "North London Red"],
    "Manchester United": ["Man Utd", "Man United", "Man^U^nited"],
    "Manchester City": ["Man City"],
    "Tottenham Hotspur": ["Tottenham", "Spurs"],
    "Wolverhampton Wanderers": ["Wolves"],
    "West Ham United": ["West Ham", "Westham United"],
  ...
  // Treat the short form West Ham as an alias of the official club name.
  // This prevents an EI value of West Ham conflicting with AI Westham United.
  window.FOOTBALL_CLUBS = [...new Set([...clubNames.filter((name) => name !== 'West Ham'), ...additionalClubNames])]
